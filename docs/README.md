...
| [post_defense_master_todos.md](post_defense_master_todos.md) | **POST-DEFENSE START HERE** — consolidated master TODO list: every queued experiment categorized by project (marble/leitmotifs/both), priority (P0–P2), and effort, with a cold-restart state-of-the-world section |
